...
export const STARTER_LESSONS: LessonDef[] = [
  ...
  { id: "lesson-sb-4", unitId: "unit-sb", title: "Numbers 1–3", orderIndex: 4, vocab: ["v-yi", "v-er", "v-san"], sentences: ["s-9"] },
  ...
  { id: "lesson-sb-7", unitId: "unit-sb", title: "Measure Word 个", orderIndex: 7, vocab: ["v-ge", "v-yi", "v-ren", "v-xuesheng"], sentences: ["s-9"] },
  { id: "lesson-sb-8", unitId: "unit-sb", title: "How Old Are You?", orderIndex: 8, vocab: ["v-sui", "v-ji", "v-duoda", "v-ma"], sentences: ["s-8"] },
  { id: "lesson-sb-9", unitId: "unit-sb", title: "This and That", orderIndex: 9, vocab: ["v-zhe", "v-na", "v-shi", "v-shei"], sentences: ["s-7", "s-4"] },
